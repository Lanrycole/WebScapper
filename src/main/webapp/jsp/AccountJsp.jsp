            ...
            window.onload = function () {
                ...
                for (let i = 0; i < elements.length; i++) {
                    elements[i].childNodes[0].onclick = function () {
                        ...
                        var idInput = createTextInput(idCell.innerText, "<%=AccountLogic.ID%>");
                        idInput.readOnly = true;
                        var nameInput = createTextInput(nameCell.innerText, "<%=AccountLogic.DISPLAY_NAME%>");
        ...
        <form method="post">
            ...
            <table align="center" border="1">
                ...
                <%
                    ...
                    List<Account> hosts = logic.getAll();
                    long counter = 0;
                ...
                <tr>
                    ...
                    <td class="Name" id="<%=counter++%>" ><%=host.getDisplayName()%></td>
                    <td class="Name" id="<%=counter++%>" ><%=host.getUser()%></td>
                    <td class="Name" id="<%=counter++%>" ><%=host.getPassword()%></td>
                </tr>
                <%
                    }
                %>
