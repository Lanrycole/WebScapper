...
public class Scraper {
     ...
     * instructions
     */
    private static final String CLIENT_ID = "8_NWnYywo7WbmQ";
    private static final String CLIENT_SECRET = "Kvu4akWSjAPUqYAxuT0ESU8Y6Ug";
    private static final String REDDIT_USER = "lanrycole";

    /**
     * replace yourname with your name in the text below, no spaces and
     * lowercase
     */
    private static final String APPID = "orey0001";
