...
public class ImageTable extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title> ImageTable</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            List<String> print = imagelogic.getColumnNames();
            ...
            for(String col : print){
               ...
               for(Image e: entity){
                out.printf("<tr>"
                        ...
                        + "<td>%s</td>"
                        + "<td>%s</td>"
                        + "</tr>", e.getId(), e.getFeedid(), e.getPath(), e.getDate(), e.getName());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        processRequest(request, response);
             ...
             ImageLogic imagelogic = new ImageLogic();
                Image savedImage= imagelogic.createEntity(request.getParameterMap());
                FeedLogic feedlogic = new FeedLogic(); 
                Feed savedfeed =feedlogic.getWithId(1);   
